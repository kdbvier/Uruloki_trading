...
const Dropdown : React.FC<DropdownOption> = ({allTokenName}) => {
    ...
    return (
        <div className="relative inline-block text-left w-28">
            ...
            {isOpen && (
                <div
                    className="absolute left-0 w-full mt-2 origin-top-right bg-tsuka-400 divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
