              ...
              <div className="w-full flex justify-between items-center bg-tsuka-500 outline-none border border-tsuka-400 rounded-md  px-[19px] py-[11px] mb-[9px]">
                ...
                <div
                  ...
                  style={{
                    color: "#FFFFFF",
                    backgroundColor:
                      backgroundInfo[getBackgroundIndex(Cards[1].name)].color,
                    backgroundImage:
                      backgroundInfo[getBackgroundIndex(Cards[1].name)]
                        ?.backgroundImage,
                  }}
                >
                  <TokenIconsToken
                    name={Cards[1].name}
                    shortName={Cards[1].shortName}
                    width={24}
                    height={24}
                  ></TokenIconsToken>
              ...
              <div className="w-full flex flex-col items-center h-[112px] rounded-lg bg-gradient-to-b from-tsuka-500 to-tsuka-400 mb-[9px] overflow-y-scroll">
                <div className="w-full grid gap-2 grid-cols-3 px-[8px] py-[10px]">
                  {Cards?.map((card, index) => (
                    <div
                      key={index}
                      className="flex justify-between py-[6px] px-[6.92px] rounded-md items-center bg-no-repeat bg-cover	"
                      style={{
                        color: "#FFFFFF",
                        backgroundColor:
