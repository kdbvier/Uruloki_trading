...
export default {
  ...
  args: {
    ...
    afterMainText:"Discover the key features of Uruloki, the all-in-one platform for decentralized asset trading",
    items: [
      {
        title: "Simplify Your Trading with our Order Book",
        description: "Keep track of all of your decentralized assets in one place with Uruloki's order book feature.",
        icon: {
      ...
      },
      {
        ...
        description: "Group multiple orders on different assets into a single strategy and take advantage of market inefficiencies.",
        icon: {
      ...
      },
      {
        ...
        description: "Automate your trades with Uruloki's featurke to execute trades automatically based on pre-set conditions.",
        icon: {
