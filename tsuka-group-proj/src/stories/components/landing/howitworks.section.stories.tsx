  ...
  args: {
    ...
    image: {
      ...
      },
      {
        ...
        description: "Create a trading strategy with Uruloki by grouping multiple orders on different assets into a single arbitrage strategy. Choose the assets you want to include and take advantage of market inefficiencies.",
        orientation: false,
        features: [
      ...
      },
      {
        ...
        description: "With Uruloki's real-time monitoring and management, you can stay up-to-date with your trading activity and make informed decisions based on advanced tools and analytics. Customize your trading strategy and maximize your profits with ease.",
        orientation: true,
        features: [
