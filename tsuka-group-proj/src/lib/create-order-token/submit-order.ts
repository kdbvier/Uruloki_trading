...
export const createOrderInDb = async (selectedOrder: Order, amount: string, isBuy: boolean, isRange: boolean,
    newOrderPriceInfo: CreateOrderPriceInfoProps, token1Symbol: string, token2Symbol: string, isContinuous: boolean,
...
const createPriceRangeOrderInContract = async (createContinuousPriceRangeOrder: any, createNonContinuousPriceRangeOrder: any, order: Order, tokenPairInfo: TokenPairInfo): Promise<EditOrderResult> => {
...
const createTargetPriceOrderInContract = async (createContinuousTargetPriceOrder: any, createNonContinuousTargetPriceOrder: any, order: Order, tokenPairInfo: TokenPairInfo): Promise<EditOrderResult> => {
